...
def setup_gradio_interface() -> gr.Blocks:
    ...
    with gr.Blocks(title="VoiceTranscriber") as interface:
        ...
        transcribe_btn.click(
            ...
            inputs=[input_voice, model_id, batch_size],
            outputs=output_text,
        )
...
def transcribe_voice_wrapper(voice_fp: str, model_id: str, batch_size: int) -> str:
    """
    ...
    try:
        ...
        transcribed_text = pipeline(voice_fp, batch_size=batch_size)
...
def model_init_wrapper(model_id: str) -> str:
    ...
    try:
        _text = transcribe_voice_wrapper(
            voice_fp=test_voice_fp, model_id=model_id, batch_size=2
        )
        return (
